        ...
        <div className="rounded-3xl border border-zinc-800 bg-zinc-950 p-4 shadow-2xl">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
            <input
              ...
              className="w-full rounded-2xl border border-zinc-800 bg-black px-4 py-3 text-sm text-white outline-none placeholder:text-zinc-500"
            />
              ...
              <tbody className="divide-y divide-zinc-900">
                {loading ? (
                  ...
                  restaurants.map((restaurant) => (
                    <tr key={restaurant.id} className="transition hover:bg-zinc-900/40">
